...
class EditProfieWidget extends StatefulWidget {
  ...
  static String routeName = 'editProfie';
  static String routePath = 'editProfie';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> editProfieUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editProfieUsersRecord = editProfieUsersRecordList.isNotEmpty
            ? editProfieUsersRecordList.first
            : null;
